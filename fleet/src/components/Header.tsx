...
export function Header({ user }: { user: { name?: string; email?: string; role: string } }) {
  ...
  return (
    <header style={{ height: '52px', background: 'rgba(15,23,42,0.95)', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', padding: '0 1.5rem', gap: '12px', position: 'sticky', top: 0, zIndex: 40 }}>
